...
class GetAllPaymentsRequest extends FormRequest
{
    private const DEFAULT_ORDER_BY = 'payment_date';
    ...
    {
        return $this->user()->can('payments.viewAny');
    }
    ...
    {
        return ['id', 'amount', 'payment_date', 'created_at'];
    }
}
