...
class GetAllDentalChartEntriesRequest extends FormRequest
{
    private const DEFAULT_ORDER_BY = 'id';
    private const DEFAULT_ORDER_DIR = 'asc';
    private const DEFAULT_LIMIT = 32; // Normal human mouth has 32 teeth
    private const MAX_LIMIT = 100;

    public function authorize(): bool
    {
        return $this->user()->can('dental_chart_entries.viewAny');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'dental_chart_id' => ['nullable', 'integer', 'exists:dental_charts,id'],
            'tooth_condition_id' => ['nullable', 'integer', 'exists:tooth_conditions,id'],
    ...
    {
        return ['id', 'tooth_number', 'created_at'];
    }
}
