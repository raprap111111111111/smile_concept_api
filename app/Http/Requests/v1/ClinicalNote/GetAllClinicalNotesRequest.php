...
class GetAllClinicalNotesRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('clinical_notes.viewAny');
    }
    ...
    {
        return ['id', 'appointment_id', 'doctor_id', 'is_locked', 'created_at'];
    }
}
