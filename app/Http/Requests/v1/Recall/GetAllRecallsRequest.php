...
class GetAllRecallsRequest extends FormRequest
{
    private const DEFAULT_ORDER_BY = 'due_date';
    ...
    {
        return $this->user()->can('recalls.viewAny');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'recall_type_id' => ['nullable', 'integer', 'exists:recall_types,id'],
            'status' => ['nullable', 'string', Rule::enum(RecallStatus::class)],
    ...
    {
        return ['id', 'due_date', 'status', 'last_notified_at', 'created_at'];
    }
}
